...
INSERT INTO upgrades (
    internal_name, effect, value_tier_1, name_tier_1
    ) 
VALUES (
    'meals', 'EXPONENT', 1.1, 'Regular Meals'
);
...
VALUES (
    'housing', 'EXPONENT', 1.1, 'Good Housing'
);
...
VALUES (
    'helmet', 'MULTIPLY', 1.5, 'Mining Helmet'
);
...
VALUES (
    'cartographer', 'MULTIPLY', 3, 'Cartographer Assistant'
);